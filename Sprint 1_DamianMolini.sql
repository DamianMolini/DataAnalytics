...
#Exercici 5: El teu cap identifica un error amb la companyia que té aneu 'b-2354'. Per tant, et sol·licita que li indiquis el país i nom de companyia d'aquest aneu.
...
SELECT
	DATE(timestamp) AS date,
    amount,
    SUM(amount) OVER(ORDER BY amount ASC) AS running_total
FROM transaction
ORDER BY 2 ASC
LIMIT 5;
